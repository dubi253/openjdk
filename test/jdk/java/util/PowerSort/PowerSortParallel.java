...
public class PowerSortParallel implements Sorter {
    ...
    public PowerSortParallel(final boolean useMsbMergeType, final boolean onlyIncreasingRuns, final int minRunLen) {
    ...
    public String toString() {
        return "PowerSortParallel" + (useMsbMergeType ? "-msb" : "") + (onlyIncreasingRuns ? "-inc" : "") + "-minRunLen-" + myMinRunLen;
    }
